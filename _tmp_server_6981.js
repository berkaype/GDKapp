...
function initializeDatabase() {
  ...
  const productData = [
  ["Baget Karisik Sandviç", "Sandviç", 90, new Date().toISOString().split('T')[0]],
  ["Baget Karisik Sandviç EXTRA", "Sandviç Extra", 180, new Date().toISOString().split('T')[0]],
  ["Sandviç (Yarim Ekmek)", "Sandviç", 90, new Date().toISOString().split('T')[0]],
  ["Sandviç EXTRA (Yarim Ekmek)", "Sandviç Extra", 180, new Date().toISOString().split('T')[0]],
  ["Tost (Yarim Ekmek)", "Tost", 130, new Date().toISOString().split('T')[0]],
  ["Döner (Yarim Ekmek)", "Döner", 90, new Date().toISOString().split('T')[0]],
  ["Döner (Lavas)", "Döner", 110, new Date().toISOString().split('T')[0]],
  ["Döner Porsiyon", "Döner Porsiyon", 180, new Date().toISOString().split('T')[0]],
  ["Döner Porsiyon (Pilavli)", "Döner Porsiyon", 210, new Date().toISOString().split('T')[0]],
  ...
  ["Gazli Mesrubat", "Içecek", 50, new Date().toISOString().split('T')[0]],
  ["Portakal Suyu", "Içecek", 80, new Date().toISOString().split('T')[0]],
  ["Nar Suyu", "Içecek", 100, new Date().toISOString().split('T')[0]],
  ["Ayran (Büyük)", "Içecek", 30, new Date().toISOString().split('T')[0]],
  ["Ayran (Küçük)", "Içecek", 15, new Date().toISOString().split('T')[0]],
  ["Su", "Içecek", 20, new Date().toISOString().split('T')[0]],
  ["Çay (Büyük)", "Içecek", 30, new Date().toISOString().split('T')[0]],
  ["Çay (Küçük)", "Içecek", 20, new Date().toISOString().split('T')[0]]
];
